...
export default function Modos() {
  ...
  const [rowsColumns, setRowsColumns] = useState([0, 0]);
  ...
  const setGame = (mode) => {
    ...
    switch (mode) {
      ...
      case "inter": // modo intermedio
        setNumberOfWords(7);
        setRowsColumns([12, 12]);
        setTimer(1000);
        break;
      case "avan": // modo avançado
        setNumberOfWords(10);
        setRowsColumns([16, 16]);
        setTimer(100);
        break;
      default:
        setNumberOfWords(0);
    ...
    <>
      ...
      <div className="pre-visualizacao">
        ...
        <div className={`pre-view ${isHovering ? "" : "hidden"}`}>
          ...
          {/*APAGARRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR*/}
          {console.log(timer, rowsColumns)}{" "}
          {/*APAGARRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR*/}
